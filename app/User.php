...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email_verified_at','email', 'password', 'account_role'
    ];
    ...
    {
        return $this->account_role == 0 ? true : false;
    }

    public function isClient()
    {
        return $this->account_role == 2 ? true : false;
    }


    public function userCountry($code)
    {
    ...
    // one to one relation with clients table
    ...
    // Return many to one relation with Order Unfollow table
